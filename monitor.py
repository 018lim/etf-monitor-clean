...
[실시간 시장 감시 프로그램]
 ...
 기술적 특징:
   - 통계적 분석: yfinance API를 통해 수집된 1,250일간의 시계열 데이터를 바탕으로 등락률의 평균과 표준편차(σ) 산출
   - 목적: 정규분포 가정을 바탕으로 등락률이  평균 ±2σ(신뢰수준 약 95%)를 벗어나는 변동성 포착 시 알림 송출
   - 실무 자동화: 텔레그램 API 연동을 통한 실시간 모니터링 및 장중 시간 자동 인식 루프 구현
